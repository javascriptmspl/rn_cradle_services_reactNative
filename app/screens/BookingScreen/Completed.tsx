...
import { ExploreStackParams, ProfileStackParams } from "../../navigation/types";
import { RegularText, SmallText, SmallText10, SmallTextB } from "../../components/MyText";
...
const Item = ({ name, skill, price, img }: any) => {
  ...
  return (
    <Pressable
    onPress={()=>navigation.navigate('CompleteBooking')}
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          <View style={styles.btn}>
            <SmallText10 style={{ color: "white" }} bold>Completed</SmallText10>
          </View>
        </View>
        {/* {LOCATION} */}
